        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!--main content-->
                    <form id="commentForm" action="{{ route('category.store') }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input id="no_of_student" name="no_of_student" type="text"
                                       placeholder="Number Of Student" class="form-control required"
                                       value="{!! old('no_of_student') !!}"/>
                            </div>
                        </div>
                        <div class="form-group">
