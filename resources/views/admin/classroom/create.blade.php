        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <!--main content-->
                    <form id="commentForm" action="{{ route('classroom.store') }}"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select name="school_name" id="school_name" class="school_name form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input id="no_of_student" name="no_of_student" type="text" placeholder="Number Of Student" class="form-control required" value="{!! old('no_of_student') !!}"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="expiry_date" class="col-sm-2 control-label">Expiry Date:</label>
                        <div class="col-sm-10">
                            <input type="text" name="expiry_date" class="form-control required" id="rangepicker4">
                        </div>
                        <!-- /.input group -->
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <input type="checkbox" name="courses[]" class="courses" value="{{ $course->id }}"> {{ $course->name }}<br/>
                            @endforeach
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-4">
                            <a class="btn btn-danger" href="{{ url('admin/classroom') }}">
                                Cancel
                            </a>
...
<script src="{{ asset('assets/js/pages/addclassroom.js') }}"></script>
