...
<div class="fullcol">
    ...
    <div class="section">
        ...
        <div class="icons">
            <img src="{{ asset('front_assets/images/icon-subscribe.png') }}" alt="">
            <img src="{{ asset('front_assets/images/icon-interactive.png') }}" alt="">
            <img src="{{ asset('front_assets/images/icon-unlock.png') }}" alt="">
        </div>
    </div>
    <div class="sectionbg">
        ...
        <div class="has-error">
            ...
            {!! $errors->first('comment_type', '<span class="help-block">:message</span>') !!}
            {!! $errors->first('comment', '<span class="help-block">:message</span>') !!}
        </div>
        <form class="contact" method="post" action="{{ route('support') }}">
