...
<html lang="en">
    <head>
        ...
        <link href="{{ asset('front_assets/css/style.css?v=1.0.25') }}" media="screen" rel="stylesheet" type="text/css" />
    ...
    <body class="public">
                    ...
                    <div id="topnav">
                        <div class="inner">
                            ...
                            <ul class="publicnav" id="b2">
                                <li {!! (Request::is('/') ? 'class="active" id="active"' : '') !!} ><a href="{{ route('home') }}">Home</a></li>
                                <li {!! (Request::is('courses') ? 'class="active" id="active"' : '') !!} ><a href="{{ route('courses') }}">Courses</a></li>
                                <li {!! (Request::is('support') ? 'class="active" id="active"' : '') !!} ><a href="{{ route('support') }}">Contact Us</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <script type="text/javascript" src="{{ asset('front_assets/script/public-actions.js') }}"></script>
        <script type="text/javascript" src="{{ asset('front_assets/script/popup.js') }}"></script>
        @yield('page_js')
    </body>
</html>
