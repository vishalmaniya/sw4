...
class DistrictController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $objdistrict->id = $this->get_primary_key('district');
        $objdistrict->name = $request->input('name');
        $objdistrict->save();
    ...
    public function destroy($id)
    {
        ...
        $district->delete();
        return Redirect::route('district.index')->with('success', 'Courses Deleted Successfully');
