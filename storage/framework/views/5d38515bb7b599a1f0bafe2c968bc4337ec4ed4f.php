...
<!--             <ul class="alerts">
             ...
             <div cellpadding="0" cellspacing="0" class="public_course_list">
                 ...
                 <div class="row">
                   <div class="col1">
                      <a href="#"><img src="http://www.studioweb.com/uploads/<?php echo e($course->slug); ?>/badge_sml.png"></a>
                   </div>
                   <div class="col2">
                      <h3><?php echo e($course->name); ?> <span id="<?php echo e($course->category->name); ?>"><?php echo e($course->category->name); ?></span></h3>
                      ...
                      <p>
                         <a href="<?php echo e(route('user_courses_view',['name'=>$course->slug])); ?>" class="button_green_sml">Review Course Material</a>
                      </p>
                      <?php if(!empty($course->source)): ?>
                      <p class="left-wrap" style="margin-top: 30px;">
                         <a href="http://www.studioweb.com/uploads/<?php echo e($course->slug); ?>/<?php echo e($course->source); ?>">
                      ...
                      <p style="margin-top: 30px;">
                         <a href="http://dev.studioweb.com/questions_answers/<?php echo e($course->id); ?>">
