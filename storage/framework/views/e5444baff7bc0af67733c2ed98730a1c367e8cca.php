...
<li <?php echo (Request::is('admin/school') || Request::is('admin/users/create') || Request::is('admin/school/*') ? 'class="active"' : ''); ?>>
    <a href="#">
        <i class="livicon" data-name="list" data-size="18" data-c="#F89A14" data-hc="#F89A14"
           data-loop="true"></i>
    ...
    <ul class="sub-menu">
        <li <?php echo (Request::is('admin/district') ? 'class="active" id="active"' : ''); ?>>
            <a href="<?php echo e(URL::to('admin/school')); ?>">
                <i class="fa fa-angle-double-right"></i>
                School List
            </a>
        </li>
        <li <?php echo (Request::is('admin/district/create') ? 'class="active" id="active"' : ''); ?>>
...
<li <?php echo (Request::is('admin/district') || Request::is('admin/district/create') || Request::is('admin/district/*') ? 'class="active"' : ''); ?>>
    <a href="#">
        <i class="livicon" data-name="list" data-size="18" data-c="#F89A14" data-hc="#F89A14"
           data-loop="true"></i>
    ...
    <ul class="sub-menu">
        <li <?php echo (Request::is('admin/district') ? 'class="active" id="active"' : ''); ?>>
            <a href="<?php echo e(URL::to('admin/district')); ?>">
                <i class="fa fa-angle-double-right"></i>
                District
            </a>
        </li>
        <li <?php echo (Request::is('admin/district/create') ? 'class="active" id="active"' : ''); ?>>
            <a href="<?php echo e(URL::to('admin/district/create')); ?>">
                <i class="fa fa-angle-double-right"></i>
                Add District
            </a>
        </li>
...
<li <?php echo (Request::is('admin/classroom') || Request::is('admin/classroom/create') || Request::is('admin/classroom/*') || Request::is('admin/csv_update') ? 'class="active"' : ''); ?>>
    <a href="#">
    ...
    <ul class="sub-menu">
        ...
        <li <?php echo (Request::is('admin/csv_update') ? 'class="active" id="active"' : ''); ?>>
            <a href="<?php echo e(URL::to('admin/csv_update')); ?>">
                <i class="fa fa-angle-double-right"></i>
...
<li <?php echo (Request::is('admin/unlock_question') ? 'class="active"' : ''); ?>>
    <a href="<?php echo e(URL::to('admin/unlock_question')); ?>">
