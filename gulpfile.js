...
elixir(function (mix) {
   ...
   // mix.copy('resources/assets/css/pages/blueimp-gallery.min.css', 'public/assets/css/pages');
    ...
    mix.copy('resources/assets/vendors/Sortable/st/app.css', 'public/assets/vendors/Sortable/css');
    ...
    mix.copy('resources/assets/vendors/x-editable/dist/inputs-ext/typeaheadjs/lib/typeahead.js-bootstrap.css', 'public/assets/vendors/x-editable/js');
